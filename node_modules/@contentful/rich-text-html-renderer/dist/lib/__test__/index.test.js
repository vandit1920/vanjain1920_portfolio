...
describe('documentToHtmlString', function () {
    ...
    it('renders marks with default mark renderer', function () {
        var docs = [
            ...
            {
                doc: (0, documents_1.marksDoc)(rich_text_types_1.MARKS.STRIKETHROUGH),
    ...
    it('renders default resource link block', function () {
        var resourceLink = {
            sys: {
        ...
        var document = (0, documents_1.embeddedResourceDoc)(resourceLink);
        var expected = "<div></div>";
        expect((0, index_1.documentToHtmlString)(document)).toEqual(expected);
    });
    ...
    it('preserves whitespace with preserveWhitespace option', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
    ...
    it('preserves line breaks with preserveWhitespace option', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
        ...
        var expected = '<p>hello<br/>world</p>';
        expect((0, index_1.documentToHtmlString)(document, options)).toEqual(expected);
    });
    it('preserves both spaces and line breaks with preserveWhitespace option', function () {
        var document = {
            nodeType: rich_text_types_1.BLOCKS.DOCUMENT,
            data: {},
            content: [
